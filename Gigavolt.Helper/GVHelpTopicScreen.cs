...
namespace Game {
    public class GVHelpTopicScreen : RecipaediaDescriptionScreen {
        ...
        public static Dictionary<Type, I18NHelp> m_type2I18NHelp = new() {
            {
                typeof(GVDigitalToAnalogConverterBlock),
                new I18NHelp {
                    WebUrl = "base/shift/converter.html",
                    WebUrlSuffixZh = "#数模转换器",
                    WebUrlSuffixEn = "#digital-to-analog-converter",
                    ImageName = "digital-to-analog-converter"
                }
            }, {
                typeof(GVAnalogToDigitalConverterBlock),
                new I18NHelp {
                    WebUrl = "base/shift/converter.html",
                    WebUrlSuffixZh = "#模数转换器",
                    WebUrlSuffixEn = "#analog-to-digital-converter",
                    ImageName = "analog-to-digital-converter"
                }
            },
            ...
            { typeof(GVMoreOneInOneOutBlock), new I18NHelp { WebUrl = "expand/gates/more_one_in_one_out.html", ImageName = "more_one_in_one_out" } }, {
                typeof(GVJavascriptMicrocontrollerBlock),
                new I18NHelp { WebUrl = "expand/gates/javascript_microcontroller.html", ImageName = "javascript_microcontroller" }
            },
            ...
            { typeof(GVListMemoryBankBlock), new I18NHelp { WebUrl = "expand/memory_banks/list_memory_bank.html", ImageName = "list_memory_bank" } }, {
                typeof(GVVolatileListMemoryBankBlock),
                new I18NHelp { WebUrl = "expand/memory_banks/list_memory_bank.html", ImageName = "list_memory_bank" }
            }, {
                typeof(GVFourDimensionalMemoryBankBlock),
                new I18NHelp { WebUrl = "expand/memory_banks/four_dimensional_memory_bank.html", ImageName = "four_dimensional_memory_bank" }
            }, {
                typeof(GVVolatileFourDimensionalMemoryBankBlock),
                new I18NHelp { WebUrl = "expand/memory_banks/four_dimensional_memory_bank.html", ImageName = "four_dimensional_memory_bank" }
            }, {
                typeof(GVMemoryBanksOperatorBlock),
                new I18NHelp { WebUrl = "expand/memory_banks/memory_banks_operator.html", ImageName = "memory_banks_operator" }
            },
            ...
            { typeof(GVNesEmulatorBlock), new I18NHelp { WebUrl = "expand/displays/nes_emulator.html", ImageName = "nes_emulator" } }, {
                typeof(GVTerrainRaycastDetectorBlock),
                new I18NHelp { WebUrl = "expand/sensors/terrain_raycast_detector.html", ImageName = "terrain_raycast_detector" }
            },
            ...
            { typeof(GVCameraBlock), new I18NHelp { WebUrl = "expand/sensors/camera.html", ImageName = "camera" } }, {
                typeof(GVGuidedDispenserBlock),
                new I18NHelp { WebUrl = "expand/transportation/guided_dispenser.html", ImageName = "guided_dispenser" }
            },
            { typeof(GVAttractorBlock), new I18NHelp { WebUrl = "expand/transportation/attractor.html", ImageName = "attractor" } }, {
                typeof(GVInventoryFetcherBlock),
                new I18NHelp { WebUrl = "expand/transportation/inventory_fetcher.html", ImageName = "inventory_fetcher" }
            }, {
                typeof(GVInventoryControllerBlock),
                new I18NHelp { WebUrl = "expand/transportation/inventory_controller.html", ImageName = "inventory_controller" }
            },
        ...
        public override void Enter(object[] parameters) {
            try {
                ...
                if (i18nHelp != null
                    ...
                    m_urlLabel.Text =
                        $"https://xiaofengdizhu.github.io/GigavoltDoc/{(isZh ? "zh" : "en")}/{i18nHelp.WebUrl}{(isZh ? i18nHelp.WebUrlSuffixZh : i18nHelp.WebUrlSuffixEn) ?? string.Empty}";
