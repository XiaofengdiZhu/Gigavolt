...
namespace Game
{
    public class MoreTwoInTwoOutGVElectricElement : RotateableGVElectricElement
    {
        ...
        public MoreTwoInTwoOutGVElectricElement(SubsystemGVElectricity subsystemGVElectric, CellFace cellFace, int value)
        ...
        public override uint GetOutputVoltage(int face)
        {
            ...
            {
                if (connectorDirection.Value == GVElectricConnectorDirection.Top || connectorDirection.Value == GVElectricConnectorDirection.In)
                {
                    return m_output;
                }
        ...
        public override bool Simulate()
        {
            try
            {
                ...
                switch (m_type)
                {
                    ...
                    case 2:
                        {
                            ulong result = (ulong)leftInput * (ulong)rightInput;
                            output = (uint)result;
                    ...
                    case 13:
                        {
                            ...
                            overflow = (uint)((ulong)leftInput << 32 >> (int)rightInput & (ulong)uint.MaxValue);
                        }
                        break;
                    case 14:
                        {
                            double result = System.Math.Pow(leftInput, rightInput);
                            output = (uint)result;
                    ...
                    case 15:
                        {
                            double result = System.Math.Log(leftInput, rightInput);
                            output = (uint)result;
                            overflow = 0u;
                        }
                        break;
