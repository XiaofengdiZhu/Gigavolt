...
namespace Game
{
    public class SubsystemGV8NumberLedGlow : Subsystem, IDrawable
    {
        ...
        {
            var glowPoint = new GV8NumberGlowPoint();
        ...
        public static TexturedBatch3D generateBatch(PrimitivesRenderer3D renderer, uint voltage)
        {
            ...
            return renderer.TexturedBatch(Texture2D.Load(image), false, 0, DepthStencilState.DepthRead, RasterizerState.CullCounterClockwiseScissor, BlendState.AlphaBlend, SamplerState.PointClamp);
        }
    }
}