...
namespace Game {
    public class NesEmulatorGVElectricElement : RotateableGVElectricElement {
        ...
        public NesEmulatorGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, GVCellFace cellFace, uint subterrainId) : base(
            subsystemGVElectricity,
            cellFace,
            subterrainId
        ) => m_subsystemNesEmulatorBlockBehavior = subsystemGVElectricity.Project.FindSubsystem<SubsystemNesEmulatorBlockBehavior>(true);
