...
namespace Game {
    public class GVOscilloscopeBlock : MountedGVElectricElementBlock, IGVCustomWheelPanelBlock {
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity,
            ...
            int y,
            int z,
            uint subterrainId) => new OscilloscopeGVElectricElement(subsystemGVElectricity, new GVCellFace(x, y, z, GetFace(value)), subterrainId);
