...
namespace Game {
    public class SubsystemGVVolatileListMemoryBankBlockBehavior : SubsystemGVEditableItemBehavior<GVVolatileListMemoryBankData> {
        public override int[] HandledBlocks => [GVBlocksManager.GetBlockIndex<GVVolatileListMemoryBankBlock>()];

        public SubsystemGVVolatileListMemoryBankBlockBehavior() : base(GVBlocksManager.GetBlockIndex<GVVolatileListMemoryBankBlock>()) { }
