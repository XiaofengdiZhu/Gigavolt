...
namespace Game {
    public class GVFourDimensionalMemoryBankGVElectricElement : RotateableGVElectricElement {
        public readonly SubsystemGVFourDimensionalMemoryBankBlockBehavior m_SubsystemGVMemoryBankBlockBehavior;
        public readonly SubsystemGameInfo m_subsystemGameInfo;

        public readonly GVFourDimensionalMemoryBankData m_data;
        public uint m_voltage;
        public uint m_lastBottomInput;

        public GVFourDimensionalMemoryBankGVElectricElement(SubsystemGVElectricity subsystemGVElectricity,
            GVCellFace cellFace,
            int value,
            uint subterrainId) : base(subsystemGVElectricity, cellFace, subterrainId) {
            m_SubsystemGVMemoryBankBlockBehavior =
                subsystemGVElectricity.Project.FindSubsystem<SubsystemGVFourDimensionalMemoryBankBlockBehavior>(true);
