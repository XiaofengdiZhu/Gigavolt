...
namespace Game {
    public class GVMemoryBanksOperatorBlock : RotateableMountedGVElectricElementBlock {
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z) => new MemoryBanksOperatorGVElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
