...
namespace Game
{
    public class NesEmulatorGVElectricElement : RotateableGVElectricElement
    {
        ...
        public NesEmulatorGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, CellFace cellFace)
            : base(subsystemGVElectricity, cellFace)
        {
            m_subsystemNesEmulatorBlockBehavior = subsystemGVElectricity.Project.FindSubsystem<SubsystemNesEmulatorBlockBehavior>(throwOnError: true);
        }
