...
namespace Game {
    public class GVGuidedDispenserBlock : CubeBlock, IGVElectricElementBlock {
        ...
        public override BlockPlacementData GetPlacementValue(SubsystemTerrain subsystemTerrain, ComponentMiner componentMiner, int value, TerrainRaycastResult raycastResult) {
            ...
            result.Value = Terrain.MakeBlockValue(Index, 0, SetMode(SetDirection(0, direction), Mode.Shoot));
        ...
        public GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemElectricity, int value, int x, int y, int z) => new GuidedDispenserGVElectricElement(subsystemElectricity, new Point3(x, y, z));
