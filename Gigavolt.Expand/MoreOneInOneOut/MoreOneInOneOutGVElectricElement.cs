...
namespace Game {
    public class MoreOneInOneOutGVElectricElement : RotateableGVElectricElement {
        ...
        public MoreOneInOneOutGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, GVCellFace cellFace, int value, uint subterrainId) :
            base(subsystemGVElectricity, cellFace, subterrainId) => m_type = GVMoreOneInOneOutBlock.GetType(Terrain.ExtractData(value));
        ...
        public override bool Simulate() {
            ...
            if (m_type < 14) {
                ...
                double middleOutput;
                switch (m_type) {
                    case 1: middleOutput = Math.Cos(radius); break;
                    case 2: middleOutput = Math.Tan(radius); break;
                    case 3: middleOutput = 1 / Math.Tan(radius); break;
                    case 4: middleOutput = 1 / Math.Cos(radius); break;
                    case 5: middleOutput = 1 / Math.Sin(radius); break;
                    case 6: middleOutput = Math.Asin(radius); break;
                    case 7: middleOutput = Math.Acos(radius); break;
                    case 8: middleOutput = Math.Atan(radius); break;
                    case 9: middleOutput = Math.Sinh(radius); break;
                    case 10: middleOutput = Math.Cosh(radius); break;
                    case 11: middleOutput = Math.Tanh(radius); break;
                    case 12: middleOutput = radius * Math.PI / 180; break;
                    case 13: middleOutput = radius * 180 / Math.PI; break;
                    default: middleOutput = Math.Sin(radius); break;
                }
        ...
        public static uint Double2Uint(double num) => ((num < 0 ? 1u : 0u) << 31)
