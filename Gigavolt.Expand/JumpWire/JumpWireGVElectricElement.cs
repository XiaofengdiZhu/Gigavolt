...
namespace Game {
    public class JumpWireGVElectricElement : RotateableGVElectricElement {
        ...
        public JumpWireGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, GVCellFace cellFace, uint subterrainId) : base(
        ...
        public override uint GetOutputVoltage(int face) =>
            SubsystemGVElectricity.GetConnectorDirection(CellFaces[0].Face, Rotation, face) == GVElectricConnectorDirection.Top ? m_output : 0u;
                    ...
                    if (connection.NeighborConnectorType != GVElectricConnectorType.Input) {
                        ...
                        if (connectorDirection.HasValue) {
                            if (connectorDirection.Value == GVElectricConnectorDirection.In) {
                                ...
                                m_allowBottomInput = IsSignalHigh(
