...
namespace Game {
    public class GVJumpWireBlock : RotateableMountedGVElectricElementBlock {
        ...
        public GVJumpWireBlock() : base("Models/GigavoltGates", "AndGate", 0.5f) =>
            texture = ContentManager.Get<Texture2D>("Textures/GVJumpWireBlock");
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity,
            ...
            int y,
            int z,
            uint subterrainId) => new JumpWireGVElectricElement(subsystemGVElectricity, new GVCellFace(x, y, z, GetFace(value)), subterrainId);
