...
* **Shift** 这个分类中的方块最大地发挥了2^32个电压级别的特长，既然与原版不同，当然都是十亿伏特版
> `大门、栅栏门、活板门、活塞`仅有Shift版而没有经典版。  
...
| 大门、栅栏门、活板门、活塞 | 收到的电压由0.7V及以下上升到0.8V及以上后开门或关门 | 根据收到的电压强度打开或部分打开，0V关门，0x2D V打开45度，0x5A V及以上完全打开；不提供与原版完全一致的经典版                                 |
