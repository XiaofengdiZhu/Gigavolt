namespace Game {
    public abstract class MountedGVElectricElementBlock : GVBaseBlock, IGVElectricElementBlock {
        ...
        public virtual GVElectricElement[] CreateGVElectricElements(SubsystemGVElectricity subsystemGVElectricity,
            int value,
            int x,
            int y,
            int z,
        ...
        public abstract GVElectricConnectorType? GetGVConnectorType(SubsystemGVSubterrain subsystem,
            int value,
            int face,
            int connectorFace,
            int x,
