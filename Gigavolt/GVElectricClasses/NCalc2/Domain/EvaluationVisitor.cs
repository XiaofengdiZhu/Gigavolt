...
namespace NCalc.Domain {
    public class EvaluationVisitor : LogicalExpressionVisitor {
        ...
        object Evaluate(LogicalExpression expression) {
        ...
        static readonly Type[] CommonTypes = { typeof(long), typeof(double), typeof(bool), typeof(string), typeof(decimal) };
        ...
        /// <returns></returns>
        static Type GetMostPreciseType(Type a, Type b) {
        ...
        public int CompareUsingMostPreciseType(object a, object b) {
            ...
            if (mpt.Equals(typeof(string))
                && (Ordinal || IgnoreCaseString)) {
                if (Ordinal) {
                    if (IgnoreCaseString) {
            ...
            IComparable cmp = a as IComparable;
            if (cmp != null) {
        ...
        public override void Visit(BinaryExpression expression) {
            ...
            switch (expression.Type) {
                ...
                case BinaryExpressionType.Div:
                    ...
                    Result = IsReal(left()) || IsReal(right()) ? Numbers.Divide(left(), right(), _options) : Numbers.Divide(Convert.ToDouble(left()), right(), _options);
                    break;
                ...
                case BinaryExpressionType.Plus:
                    if (left() is string) {
                        ...
                        Result = Checked ? Numbers.AddChecked(left(), right(), _options) : Numbers.Add(left(), right(), _options);
                    }
                    break;
                case BinaryExpressionType.Times:
                    Result = Checked ? Numbers.MultiplyChecked(left(), right(), _options) : Numbers.Multiply(left(), right(), _options);
                    break;
        ...
        public override void Visit(Function function) {
            FunctionArgs args = new FunctionArgs { Parameters = new Expression[function.Expressions.Length] };
            ...
            switch (function.Identifier.Name) {
                ...
                case string n when n.Equals("abs", StringComparison.OrdinalIgnoreCase):
                    ...
                    if (useDouble) {
                        Result = Math.Abs(Convert.ToDouble(Evaluate(function.Expressions[0])));
                    }
                    else {
                ...
                default: throw new ArgumentException("Function not found", function.Identifier.Name);
            }
        }

        void CheckCase(string function, string called) {
            if (IgnoreCase) {
        ...
        void OnEvaluateFunction(string name, FunctionArgs args) {
        ...
        void OnEvaluateParameter(string name, ParameterArgs args) {
