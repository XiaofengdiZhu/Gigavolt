namespace Game
{
    ...
    {
        public const int Index = 680;

        public GVDigitalToAnalogConverterCBlock()
        ...
        {
            return new DigitalToAnalogConverterGVCElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
        }
