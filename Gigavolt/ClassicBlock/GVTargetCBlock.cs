    ...
    public class GVTargetCBlock : MountedGVElectricElementBlock
    {
        ...
        public override BlockPlacementData GetPlacementValue(SubsystemTerrain subsystemTerrain, ComponentMiner componentMiner, int value, TerrainRaycastResult raycastResult)
        {
            ...
            if (raycastResult.CellFace.Face < 4)
            {
                ...
                result.Value = Terrain.MakeBlockValue(699, 0, SetMountingFace(0, raycastResult.CellFace.Face));
            }
            return result;
        }
        ...
        {
            return new TargetGVCElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
        }
