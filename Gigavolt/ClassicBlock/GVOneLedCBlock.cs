...
namespace Game
{
    public class GVOneLedCBlock : MountedGVElectricElementBlock
    {
        ...
        public override IEnumerable<CraftingRecipe> GetProceduralCraftingRecipes()
        {
            ...
            {
                ResultCount = 4,
                ResultValue = Terrain.MakeBlockValue(653, 0, 0),
        ...
        public override void GetDropValues(SubsystemTerrain subsystemTerrain, int oldValue, int newValue, int toolLevel, List<BlockDropValue> dropValues, out bool showDebris)
        {
            ...
            {
                Value = Terrain.MakeBlockValue(653, 0, 0),
                Count = 1
            });
            showDebris = true;
        }
        ...
        {
            return new OneLedGVCElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
        }
