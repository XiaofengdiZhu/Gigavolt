...
namespace Game {
    public class GVOneLedCBlock : MountedGVElectricElementBlock {
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z) => new OneLedGVCElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
