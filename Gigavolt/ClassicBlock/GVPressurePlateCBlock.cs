...
namespace Game {
    public class GVPressurePlateCBlock : MountedGVElectricElementBlock {
        ...
        public string[] m_displayNamesByMaterial = { "木质压力板", "石质压力板" };
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z, uint subterrainId) => new PressurePlateGVCElectricElement(subsystemGVElectricity, new GVCellFace(x, y, z, GetFace(value)), subterrainId);
