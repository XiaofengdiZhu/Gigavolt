...
namespace Game {
    public class GVPressurePlateCBlock : MountedGVElectricElementBlock {
        ...
        public string[] m_displayNamesByMaterial = new string[2] { "木质压力板", "石质压力板" };
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z) => new PressurePlateGVCElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
