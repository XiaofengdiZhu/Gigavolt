    ...
    public class GVDetonatorCBlock : MountedGVElectricElementBlock
    {
        ...
        public override void GenerateTerrainVertices(BlockGeometryGenerator generator, TerrainGeometry geometry, int value, int x, int y, int z)
        {
            ...
            if (num < m_blockMeshesByData.Length)
            {
                ...
                GenerateGVWireVertices(generator, value, x, y, z, GetFace(value), 0.125f, Vector2.Zero, geometry.SubsetOpaque);
            }
        }
        ...
        {
            return new DetonatorGVCElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
        }
