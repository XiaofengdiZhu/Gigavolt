...
namespace Game {
    public class GVMulticoloredLedCBlock : MountedGVElectricElementBlock {
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z) => new MulticoloredLedGVCElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
