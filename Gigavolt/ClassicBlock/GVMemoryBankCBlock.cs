namespace Game {
    public class GVMemoryBankCBlock : RotateableMountedGVElectricElementBlock {
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z) => new MemoryBankGVCElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
