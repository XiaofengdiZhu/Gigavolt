...
namespace Game
{
    public class GVMulticoloredLedBlock : MountedGVElectricElementBlock
    {
        ...
        public override IEnumerable<CraftingRecipe> GetProceduralCraftingRecipes()
        {
            ...
            {
                ResultCount = 4,
                ResultValue = Terrain.MakeBlockValue(954, 0, 0),
        ...
        {
            yield return Terrain.MakeBlockValue(954, 0, 0);
        }
        ...
        {
            return new MulticoloredLedGVElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
        }
