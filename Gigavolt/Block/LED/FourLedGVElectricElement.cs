...
namespace Game
{
    public class FourLedGVElectricElement : MountedGVElectricElement
    {
        ...
        public FourLedGVElectricElement(SubsystemGVElectricity subsystemGVElectric, CellFace cellFace)
            : base(subsystemGVElectric, cellFace)
        {
            m_subsystemGlow = subsystemGVElectric.Project.FindSubsystem<SubsystemGlow>(throwOnError: true);
        }
