...
namespace Game {
    public class _8x4LedGVElectricElement : MountedGVElectricElement {
        ...
        public _8x4LedGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, GVCellFace cellFace, uint subterrainId) : base(
            subsystemGVElectricity,
            cellFace,
            subterrainId
        ) => m_subsystemGV8x4LedGlow = subsystemGVElectricity.Project.FindSubsystem<SubsystemGV8x4LedGlow>(true);
        ...
        public override void OnAdded() {
            ...
            m_glowPoint = m_subsystemGV8x4LedGlow.AddGlowPoint(SubterrainId);
        ...
        public override void OnRemoved() {
            m_subsystemGV8x4LedGlow.RemoveGlowPoint(m_glowPoint, SubterrainId);
        }
