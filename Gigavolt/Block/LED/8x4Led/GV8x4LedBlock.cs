...
namespace Game {
    public class GV8x4LedBlock : MountedGVElectricElementBlock {
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z) => new _8x4LedGVElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
