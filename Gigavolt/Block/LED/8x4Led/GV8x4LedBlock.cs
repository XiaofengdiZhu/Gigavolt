...
namespace Game {
    public class GV8x4LedBlock : MountedGVElectricElementBlock, IGVCustomWheelPanelBlock {
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity,
            ...
            int y,
            int z,
            uint subterrainId) => new _8x4LedGVElectricElement(subsystemGVElectricity, new GVCellFace(x, y, z, GetFace(value)), subterrainId);
        ...
        public override string GetDisplayName(SubsystemTerrain subsystemTerrain, int value) =>
            LanguageControl.Get(GetType().Name, GetType(Terrain.ExtractData(value)));
