...
namespace Game
{
    public class GVLightbulbBlock : MountedGVElectricElementBlock, IPaintableBlock
    {
        ...
        {
            yield return Terrain.MakeBlockValue(839);
            int i = 0;
            while (i < 16)
            {
                yield return Terrain.MakeBlockValue(839, 0, SetColor(0, i));
                int num = i + 1;
                i = num;
            }
        }
        ...
        public override BlockPlacementData GetPlacementValue(SubsystemTerrain subsystemTerrain, ComponentMiner componentMiner, int value, TerrainRaycastResult raycastResult)
        {
            ...
            result.Value = Terrain.MakeBlockValue(839, 0, SetMountingFace(Terrain.ExtractData(value), raycastResult.CellFace.Face));
        ...
        public override void GetDropValues(SubsystemTerrain subsystemTerrain, int oldValue, int newValue, int toolLevel, List<BlockDropValue> dropValues, out bool showDebris)
        {
            ...
            {
                Value = Terrain.MakeBlockValue(839, 0, SetColor(0, color)),
                Count = 1
            });
            showDebris = true;
        }
        ...
        public override void GenerateTerrainVertices(BlockGeometryGenerator generator, TerrainGeometry geometry, int value, int x, int y, int z)
        {
            ...
            if (mountingFace < m_bulbBlockMeshes.Length)
            {
                ...
                GenerateGVWireVertices(generator, value, x, y, z, mountingFace, 0.875f, Vector2.Zero, geometry.SubsetOpaque);
            }
        }
        ...
        {
            return new LightBulbGVElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)), value);
        }
