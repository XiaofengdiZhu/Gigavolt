    ...
    public class GVLedBlock : MountedGVElectricElementBlock
    {
        ...
        public override IEnumerable<CraftingRecipe> GetProceduralCraftingRecipes()
        {
            ...
            while (color < 8)
            {
                ...
                {
                    ResultCount = 4,
                    ResultValue = Terrain.MakeBlockValue(852, 0, SetColor(0, color)),
                    RemainsCount = 1,
        ...
        public override IEnumerable<int> GetCreativeValues()
        {
            ...
            while (i < 8)
            {
                yield return Terrain.MakeBlockValue(852, 0, SetColor(0, i));
                int num = i + 1;
                i = num;
            }
        }
        ...
        public override void GetDropValues(SubsystemTerrain subsystemTerrain, int oldValue, int newValue, int toolLevel, List<BlockDropValue> dropValues, out bool showDebris)
        {
            ...
            {
                Value = Terrain.MakeBlockValue(852, 0, SetColor(0, color)),
                Count = 1
            });
            showDebris = true;
        }
        ...
        {
            return new LedGVElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
        }
