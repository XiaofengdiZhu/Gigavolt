...
namespace Game {
    public class MulticoloredLedGVElectricElement : MountedGVElectricElement {
        ...
        public MulticoloredLedGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, GVCellFace cellFace, uint subterrainId) : base(
        ...
        public override void OnAdded() {
            ...
            int mountingFace = GVMulticoloredLedBlock.GetMountingFace(
                Terrain.ExtractData(
