...
namespace Game {
    public class GV8NumberLedBlock : MountedGVElectricElementBlock, IGVCustomWheelPanelBlock {
        public const int Index = 858;
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z, uint subterrainId) => new _8NumberLedGVElectricElement(subsystemGVElectricity, new GVCellFace(x, y, z, GetFace(value)), subterrainId);
