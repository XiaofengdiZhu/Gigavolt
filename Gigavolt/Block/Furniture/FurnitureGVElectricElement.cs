...
namespace Game {
    public abstract class FurnitureGVElectricElement : GVElectricElement {
        public FurnitureGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, Point3 point, uint subterrainId) : base(
            subsystemGVElectricity,
            GetMountingCellFaces(subsystemGVElectricity, point, subterrainId),
            subterrainId
        ) { }
