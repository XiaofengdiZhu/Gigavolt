...
namespace Game {
    public class MultistateFurnitureGVElectricElement : FurnitureGVElectricElement {
        ...
        public MultistateFurnitureGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, Point3 point, uint subterrainId) : base(
        ...
        public override bool Simulate() {
            if (CalculateHighInputsCount() > 0) {
                if (m_isActionAllowed && (!m_lastActionTime.HasValue || SubsystemGVElectricity.SubsystemTime.GameTime - m_lastActionTime > 0.1)) {
                    ...
                    SubsystemGVElectricity.Project.FindSubsystem<SubsystemFurnitureBlockBehavior>(true)
