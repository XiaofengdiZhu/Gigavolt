        ...
        public GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity,
            ...
            if (design != null
                ...
                switch (design.InteractionMode) {
                    ...
                    case FurnitureInteractionMode.ConnectedMultistate:
                        return new MultistateFurnitureGVElectricElement(subsystemGVElectricity, new Point3(x, y, z), subterrainId);
                    case FurnitureInteractionMode.ElectricButton:
                        return new ButtonFurnitureGVElectricElement(subsystemGVElectricity, new Point3(x, y, z), subterrainId);
                    case FurnitureInteractionMode.ElectricSwitch:
                        return new SwitchFurnitureGVElectricElement(subsystemGVElectricity, new Point3(x, y, z), value, subterrainId);
                }
            }
            return null;
        }
            ...
            if (design != null) {
                ...
                if ((design.MountingFacesMask & (1 << num)) != 0
                    ...
                    if (!BlocksManager.Blocks[Terrain.ExtractContents(cellValue)]
                        .IsFaceTransparent(subsystem.m_subsystemTerrain, CellFace.OppositeFace(num), cellValue)) {
                        switch (design.InteractionMode) {
                            case FurnitureInteractionMode.Multistate:
