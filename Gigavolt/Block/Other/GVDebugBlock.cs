...
namespace Game
{
    public class GVDebugBlock : Block
    {
        ...
        public override void GenerateTerrainVertices(BlockGeometryGenerator generator, TerrainGeometry geometry, int value, int x, int y, int z)
        {
            ...
            {
                generator.GenerateMeshVertices(color: Color.White, block: this, x: x, y: y, z: z, blockMesh: m_blockMeshes[num], matrix: Matrix.Identity, subset: geometry.SubsetOpaque);
            }
        }
