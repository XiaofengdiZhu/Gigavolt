...
namespace Game
{
    public class SubsystemGVDebugBlockBehavior : SubsystemEditableItemBehavior<GVDebugData>
    {
        ...
        public override void Load(ValuesDictionary valuesDictionary)
        {
            ...
            if(data != null && data.Data.Length > 0 && float.TryParse(data.Data, out float speed))
            {
        ...
        public override bool OnEditInventoryItem(IInventory inventory, int slotIndex, ComponentPlayer componentPlayer)
        {
            ...
            DialogsManager.ShowDialog(componentPlayer.GuiWidget, new EditGVDebugDialog(Data, m_subsystemGVElectricity, delegate
            {
