namespace Game {
    public class GVXorGateBlock : RotateableMountedGVElectricElementBlock {
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z) => new XorGateGVElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
