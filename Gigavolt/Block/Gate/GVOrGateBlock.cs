namespace Game {
    public class GVOrGateBlock : RotateableMountedGVElectricElementBlock {
        public const int Index = 803;

        public GVOrGateBlock() : base("Models/Gates", "OrGate", 0.375f) { }

        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z) => new OrGateGVElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
