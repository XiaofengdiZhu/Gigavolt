namespace Game {
    public class DigitalToAnalogConverterGVElectricElement : RotateableGVElectricElement {
        ...
        public DigitalToAnalogConverterGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, CellFace cellFace, int value) : base(subsystemGVElectricity, cellFace) {
