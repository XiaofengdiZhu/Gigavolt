...
namespace Game {
    public class GVAndGateBlock : RotateableMountedGVElectricElementBlock, IGVCustomWheelPanelBlock {
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity,
            ...
            int y,
            int z,
            uint subterrainId) => new AndGateGVElectricElement(subsystemGVElectricity, new GVCellFace(x, y, z, GetFace(value)), subterrainId);
