...
namespace Game {
    public class GVPistonBlock : Block, IGVElectricElementBlock {
        ...
        public GVElectricConnectorType? GetConnectorType(SubsystemTerrain terrain, int value, int face, int connectorFace, int x, int y, int z) => GVElectricConnectorType.Input;
        ...
        public override void GetDropValues(SubsystemTerrain subsystemTerrain, int oldValue, int newValue, int toolLevel, List<BlockDropValue> dropValues, out bool showDebris) {
            ...
            dropValues.Add(new BlockDropValue { Value = Terrain.MakeBlockValue(Index, 0, SetFace(SetIsExtended(data, false), 0)), Count = 1 });
            showDebris = true;
        }
