...
namespace Game {
    public class GVDetonatorBlock : MountedGVElectricElementBlock {
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z) => new DetonatorGVElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
