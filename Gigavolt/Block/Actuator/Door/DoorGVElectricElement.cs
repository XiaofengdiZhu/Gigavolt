namespace Game {
    public class DoorGVElectricElement : GVElectricElement {
        ...
        public DoorGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, GVCellFace cellFace, uint subterrainId) : base(
        ...
        public override bool Simulate() {
            ...
            if (m_voltage != voltage) {
                ...
                m_subsystem.OpenDoor(cellFace.X, cellFace.Y, cellFace.Z, SubterrainId, MathUint.ToIntWithClamp(m_voltage));
            }
            return false;
        }
    }
