...
namespace Game {
    public class GVMotionDetectorBlock : MountedGVElectricElementBlock {
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z) => new MotionDetectorGVElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
