...
namespace Game {
    public class PhotodiodeGVElectricElement : MountedGVElectricElement {
        ...
        public PhotodiodeGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, CellFace cellFace) : base(subsystemGVElectricity, cellFace) => m_voltage = CalculateVoltage();
