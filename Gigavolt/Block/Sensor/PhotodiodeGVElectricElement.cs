...
namespace Game {
    public class PhotodiodeGVElectricElement : MountedGVElectricElement {
        ...
        public PhotodiodeGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, GVCellFace cellFace, uint subterrainId) : base(subsystemGVElectricity, cellFace, subterrainId) => m_voltage = CalculateVoltage();
        ...
        public uint CalculateVoltage() {
            ...
            Point3 position = Terrain.ToCell(Vector3.Transform(new Vector3(cellFace.X + 0.5f, cellFace.Y + 0.5f, cellFace.Z + 0.5f), GVStaticStorage.GVSubterrainSystemDictionary[SubterrainId].GlobalTransform));
