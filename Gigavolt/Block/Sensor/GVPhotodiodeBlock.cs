...
namespace Game {
    public class GVPhotodiodeBlock : MountedGVElectricElementBlock {
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, int value, int x, int y, int z) => new PhotodiodeGVElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
