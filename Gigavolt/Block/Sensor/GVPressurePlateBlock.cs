...
namespace Game {
    public class GVPressurePlateBlock : MountedGVElectricElementBlock {
        ...
        public override string GetDescription(int value) => GetClassic(Terrain.ExtractData(value))
            ? LanguageControl.Get(GetType().Name, "ClassicDescription")
        ...
        public override IEnumerable<int> GetCreativeValues() => [
            ...
            Terrain.MakeBlockValue(BlockIndex, 0, SetMaterial(0, 1)),
            Terrain.MakeBlockValue(BlockIndex, 0, SetClassic(0, true)),
            Terrain.MakeBlockValue(BlockIndex, 0, SetClassic(SetMaterial(0, 1), true))
        ];
        ...
        public override void GetDropValues(SubsystemTerrain subsystemTerrain,
            ...
            dropValues.Add(
                new BlockDropValue {
                    Value = Terrain.MakeBlockValue(BlockIndex, 0, SetClassic(SetMaterial(0, GetMaterial(oldData)), GetClassic(oldData))), Count = 1
                }
            );
            showDebris = true;
        }
        ...
        public override void DrawBlock(PrimitivesRenderer3D primitivesRenderer,
            ...
            float size,
            ref Matrix matrix,
            DrawBlockEnvironmentData environmentData) => BlocksManager.DrawMeshBlock(
            primitivesRenderer,
        ...
        public override GVElectricElement CreateGVElectricElement(SubsystemGVElectricity subsystemGVElectricity,
            ...
            int y,
            int z,
            uint subterrainId) => new PressurePlateGVElectricElement(
