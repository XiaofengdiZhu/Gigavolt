namespace Game
{
    public class GVRealTimeClockBlock : RotateableMountedGVElectricElementBlock
    {
        ...
        {
            return new RealTimeClockGVElectricElement(subsystemGVElectricity, new CellFace(x, y, z, GetFace(value)));
        }
        ...
        public override GVElectricConnectorType? GetConnectorType(SubsystemTerrain terrain, int value, int face, int connectorFace, int x, int y, int z)
        {
            ...
            if (GetFace(value) == face)
            {
                ...
                if (connectorDirection == GVElectricConnectorDirection.Top || connectorDirection == GVElectricConnectorDirection.Right || connectorDirection == GVElectricConnectorDirection.Left || connectorDirection == GVElectricConnectorDirection.Bottom || connectorDirection == GVElectricConnectorDirection.In)
                {
