...
namespace Game {
    public class RandomGeneratorGVElectricElement : RotateableGVElectricElement {
        ...
        public RandomGeneratorGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, GVCellFace cellFace, uint subterrainId) : base(
        ...
        public override bool Simulate() {
            ...
            if (flag2) {
                ...
                SubsystemGVElectricity.QueueGVElectricElementForSimulation(
                    this,
                    SubsystemGVElectricity.CircuitStep + MathUtils.Max((int)(s_random.Float(0.25f, 0.75f) / 0.01f), 1)
                );
            }
