...
namespace Game
{
    public class RealTimeClockGVElectricElement : RotateableGVElectricElement
    {
        ...
        public uint m_lastClockValue = 0u;

        public RealTimeClockGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, CellFace cellFace)
            : base(subsystemGVElectricity, cellFace)
        {
            m_subsystemTimeOfDay = SubsystemGVElectricity.Project.FindSubsystem<SubsystemTimeOfDay>(throwOnError: true);
        }
        ...
        public uint GetClockValue()
        {
            return (uint)(m_subsystemTimeOfDay.Day * 4096);
        }
    }
}
