...
namespace Game {
    public class WireDomainGVElectricElement : GVElectricElement {
        ...
        public WireDomainGVElectricElement(SubsystemGVElectricity subsystemGVElectricity, IEnumerable<GVCellFace> cellFaces, uint subterrainId) :
            base(subsystemGVElectricity, cellFaces, subterrainId) { }
        ...
        public override void OnNeighborBlockChanged(CellFace cellFace, int neighborX, int neighborY, int neighborZ) {
            ...
            if (GVWireBlock.WireExistsOnFace(cellValue, cellFace.Face)) {
                ...
                if (block.IsFaceNonAttachable(SubsystemGVElectricity.SubsystemTerrain, cellFace.Face, cellValue2, cellValue)) {
