...
namespace Game
{
    public class WireDomainGVElectricElement : GVElectricElement
    {
        ...
        public WireDomainGVElectricElement(SubsystemGVElectricity subsystemGVElectric, IEnumerable<CellFace> cellFaces)
            : base(subsystemGVElectric, cellFaces)
        {
        }
        ...
        public override void OnNeighborBlockChanged(CellFace cellFace, int neighborX, int neighborY, int neighborZ)
        {
            ...
            else if (num2 != wireFacesBitmask)
            {
                ...
                SubsystemGVElectricity.SubsystemTerrain.DestroyCell(0, cellFace.X, cellFace.Y, cellFace.Z, newValue, noDrop: false, noParticleSystem: false);
            }
        }
    }
}