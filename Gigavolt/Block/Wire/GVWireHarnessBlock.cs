...
namespace Game {
    public class GVWireHarnessBlock : GenerateGVWireVerticesBlock, IGVElectricWireElementBlock {
        ...
        public override BlockPlacementData GetPlacementValue(SubsystemTerrain subsystemTerrain, ComponentMiner componentMiner, int value, TerrainRaycastResult raycastResult) {
            ...
            return new BlockPlacementData { Value = SetWireFacesBitmask(value, (1 << raycastResult.CellFace.Face) | (BlocksManager.Blocks[Terrain.ExtractContents(cellValue)] is GVWireHarnessBlock ? GetWireFacesBitmask(cellValue) : 0)), CellFace = raycastResult.CellFace };
        }
